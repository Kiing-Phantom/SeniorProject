        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="../lead/search_order_details.php"><span class="fa fa-search"></span> Search</a></li>
                ...
                <table class="table">
                    ...
                    <?php foreach (OrderDetailController::getAllDetails() as $od) : ?>
                        <tr>
                            ...
                            <td><?php $prod = $od -> getProductId(); $STRINGNAME = ProductController::productName( $prod ); echo $STRINGNAME?></td>
