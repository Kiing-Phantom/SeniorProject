<?php
session_start();
include_once('../../controller/employee_controller.php');
...
if ( isset( $_POST[ 'save' ] ) ) {
    if ( !empty( $_POST[ 'search' ] ) ) {
        $search = $_POST[ 'search' ];
        $employee_details = EmployeeController::searchEmployees( $search );
    }
}
?>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="form-group">
                        <label class="control-label col-sm-4"><b>Search Employee Information</b></label>
                        <div class="col-sm-4">
                        <input type="text" class="form-control" name="search" placeholder="Enter Employee Information to Search...">
                        </div>
                        <div class="col-sm-2">
                    ...
                    <tbody>
                            ...
                            if(!$employee_details) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo '('.substr($value['Phone'], 0, 3).') '.substr($value['Phone'], 3, 3).'-'.substr($value['Phone'],6); ?></td>
