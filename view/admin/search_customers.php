...
if ( isset( $_POST[ 'save' ] ) ) {
    if ( !empty( $_POST[ 'search' ] ) ) {
        $search = $_POST[ 'search' ];
        $customer_details = CustomerController::searchCustomers( $search );
    }
}
?>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="form-group">
                        <label class="control-label col-sm-4"><b>Search Customer Information</b></label>
                        <div class="col-sm-4">
                        <input type="text" class="form-control" name="search" placeholder="Enter Customer Information to Search...">
                        </div>
                        <div class="col-sm-2">
